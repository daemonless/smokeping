...
[![OCI Pulls](https://img.shields.io/docker/pulls/daemonless/smokeping?style=flat-square&label=OCI+Pulls&color=blue)](https://hub.docker.com/r/daemonless/smokeping)
...
| :--- | :--- | :--- |
| `pkg` | **FreeBSD Port**. Built from FreeBSD packages. | Production stability. |
...
bastille create -O \
  ...
  --env PGID=1000 \
  --env TZ=UTC \
  --volume /path/to/containers/smokeping /config \
  --volume /path/to/containers/smokeping/data /data \
